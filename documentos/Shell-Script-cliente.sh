...
sudo docker pull eduardomiyasaki/captura-python-cliente:v5

echo "Instanciando o container, com a imagem do DockerHub (Python)"
sudo docker run -d -p 5000:5000 --name containerpythoncliente eduardomiyasaki/captura-python-cliente:v5
