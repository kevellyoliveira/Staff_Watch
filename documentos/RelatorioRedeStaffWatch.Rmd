...
ggplot(pctEnvlatencia, aes(x = pacotesEnv$captura, y = latencia$captura)) +
  ...
  labs(title = "Pacotes enviados vs Latencia", x = "Pacotes enviados (bytes)", y = "Latencia (Ms)")
...
ggplot(CPUlatencia, aes(x = usoCpu$captura, y = latencia$captura)) +
  ...
  labs(title = "Uso de CPU vs Latencia", x = "Uso de CPU (%)", y = "Latencia (Ms)")
...
ggplot(pctPerdidoslatencia, aes(x = pctPerdidos$captura, y = latencia$captura)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE, color = "lightgreen") +  # Adiciona a linha de regressão
  labs(title = "Pacotes enviados vs Latencia", x = "Pacotes enviados (bytes)", y = "Latencia (Ms)")
